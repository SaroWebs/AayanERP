...
export function AddNew({ opened, onClose, clients, loading: clientsLoading }: Props) {
    ...
    const handleSubmit = (values: Partial<Quotation>) => {
        // Calculate final amounts before submission
        const finalTotals = {
        ...
        const submissionData = {
            ...
            advance_percentage: values.advance_percentage || 0,
        ...
        axios.post(route('sales.quotations.store'), submissionData)
            .then(() => {
        ...
        >
            <form onSubmit={form.onSubmit(handleSubmit)}>
                <Stack gap="md">
                    ...
                    <Paper withBorder p="md">
                        <Title order={4} mb="md">Location & Site Details</Title>
                        <Grid>
                            <Grid.Col span={6}>
                                <TextInput
                                    label="Deployment State"
                                    placeholder="Enter deployment state"
