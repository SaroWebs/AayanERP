import { Button, Group, Stack, Text, Badge, Divider, Grid, Paper } from '@mantine/core';
...
export function ViewItem({ quotation, clients, loading }: Props) {
