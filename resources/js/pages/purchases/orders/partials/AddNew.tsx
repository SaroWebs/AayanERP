...
export function AddNew({ opened, onClose, vendors, departments, purchaseIntents, loading: dataLoading }: Props) {
    ...
    const handleSubmit = (values: Partial<PurchaseOrder>) => {
        router.post(route('purchases.orders.store'), values as Record<string, any>, {
            onSuccess: () => {
                        ...
                        <Grid>
                            <Grid.Col span={6}>
                                <Select
                                    ...
                                    onChange={(value) => form.setFieldValue('purchase_intent_id', value ? Number(value) : undefined)}
                                    clearable
                                />
                            </Grid.Col>
                            <Grid.Col span={6}>
                            ...
                            <Grid>
                                ...
                                <Grid.Col span={2}>
                                    <NumberInput
                                        ...
                                        onChange={(value) => itemForm.setFieldValue('quantity', typeof value === 'number' ? value : 1)}
                                        min={1}
                                    />
                                </Grid.Col>
                                <Grid.Col span={2}>
                                    <NumberInput
                                        ...
                                        onChange={(value) => itemForm.setFieldValue('unit_price', typeof value === 'number' ? value : 0)}
                                        min={0}
                                    />
                                </Grid.Col>
                                <Grid.Col span={2}>
